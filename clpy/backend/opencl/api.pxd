...
cdef extern from "CL/cl.h":
    ...
    cl_mem clCreatePipe(cl_context, cl_mem_flags, cl_uint, cl_uint, const cl_pipe_properties *, cl_int *)
    ...
    cl_sampler clCreateSamplerWithProperties(cl_context, const cl_sampler_properties *, cl_int *)
    ...
    cl_int clSetKernelExecInfo(cl_kernel, cl_kernel_exec_info, size_t, const void *)
    ...
    cl_int clEnqueueSVMFree(cl_command_queue, cl_uint, void *[], void(*)(cl_command_queue, cl_uint, void *[], void *), void *, cl_uint, const cl_event *, cl_event *)
    cl_int clEnqueueSVMMemcpy(cl_command_queue, cl_bool, void *, const void *, size_t, cl_uint, const cl_event *, cl_event *)
    cl_int clEnqueueSVMMemFill(cl_command_queue, void *, const void *, size_t, size_t, cl_uint, const cl_event *, cl_event *)
