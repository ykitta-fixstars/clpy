...
def count_nonzero(a, axis=None):
    ...
    .. note::
       ...
       but :func:`clpy.count_nonzero` returns zero-dimensional array to reduce
       CPU-GPU synchronization.

    Args:
        a (clpy.ndarray): The array for which to count non-zeros.
    ...
    Returns:
        clpy.ndarray of int: Number of non-zero values in the array
