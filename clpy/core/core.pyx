...
cdef _argmin = create_reduction_func(
    'clpy_argmin',
    (('?->?', ('create2_min_max_st_bool(in0, _J)', 'my_argmin(a, b, bool)', None, 'min_max_st_bool')),
     ('b->b', ('create2_min_max_st_char(in0, _J)', 'my_argmin(a, b, char)', None, 'min_max_st_char')),
     ('B->B', ('create2_min_max_st_uchar(in0, _J)', 'my_argmin(a, b, uchar)', None, 'min_max_st_uchar')),
     ('h->h', ('create2_min_max_st_short(in0, _J)', 'my_argmin(a, b, short)', None, 'min_max_st_short')),
     ('H->H', ('create2_min_max_st_ushort(in0, _J)', 'my_argmin(a, b, ushort)', None, 'min_max_st_ushort')),
     ('i->i', ('create2_min_max_st_int(in0, _J)', 'my_argmin(a, b, int)', None, 'min_max_st_int')),
     ('I->I', ('create2_min_max_st_uint(in0, _J)', 'my_argmin(a, b, uint)', None, 'min_max_st_uint')),
     ('l->l', ('create2_min_max_st_long(in0, _J)', 'my_argmin(a, b, long)', None, 'min_max_st_long')),
     ('L->L', ('create2_min_max_st_ulong(in0, _J)', 'my_argmin(a, b, ulong)', None, 'min_max_st_ulong')),
     ('q->q', ('create2_min_max_st_long(in0, _J)', 'my_argmin(a, b, long)', None, 'min_max_st_long')),
     ('Q->Q', ('create2_min_max_st_ulong(in0, _J)', 'my_argmin(a, b, ulong)', None, 'min_max_st_ulong')),
     ('f->f', ('create2_min_max_st_float(in0, _J)', 'my_argmin_float(a, b, float)', None, 'min_max_st_float')),
     ('d->d', ('create2_min_max_st_double(in0, _J)', 'my_argmin_float(a, b, double)', None, 'min_max_st_double'))),
