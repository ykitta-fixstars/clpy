...
class TestCumsum(unittest.TestCase):
    ...
    def test_invalid_axis_lower2(self, dtype):
        a = testing.shaped_arange((4, 5), clpy, dtype)
        with self.assertRaises(clpy.core.core._AxisError):
            return clpy.cumsum(a, axis=-a.ndim - 1)
...
class TestCumprod(unittest.TestCase):
    ...
    def test_invalid_axis_lower2(self, dtype):
        a = testing.shaped_arange((4, 5), clpy, dtype)
        with self.assertRaises(clpy.core.core._AxisError):
            return clpy.cumprod(a, axis=-a.ndim - 1)
    ...
    def test_invalid_axis_upper2(self, dtype):
        a = testing.shaped_arange((4, 5), clpy, dtype)
        with self.assertRaises(clpy.core.core._AxisError):
            return clpy.cumprod(a, axis=a.ndim)
